...
class AppController extends Controller {
    ...
    public function beforeFilter() {
        ...
        if($this->Auth->User("id")) {
            ...
            if(PAGE_NAME != 'image_thumb' && PAGE_NAME != 'project_menu' && PAGE_NAME != 'search_project_menu' && PAGE_NAME != 'ajax_case_menu' && !in_array(PAGE_NAME,array('recent_projects','recent_milestones','statistics','usage_details','task_progress','bug_status','leader_board'))) {
            ...
            if(PAGE_NAME != 'image_thumb' && PAGE_NAME != 'project_menu' && PAGE_NAME != 'search_project_menu' && PAGE_NAME != 'ajax_case_menu' && !in_array(PAGE_NAME,array('to_dos','recent_projects','recent_activities','recent_milestones','statistics','task_progress','bug_status','leader_board','ajax_activity'))) {
