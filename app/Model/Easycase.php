...
class Easycase extends AppModel
{
    ...
    function formatKanbanTask($statusTasklist, $caseCount, $caseMenuFilters, $closed_cases, $milestones, $projUniq, $usrDtlsArr, $frmt, $dt, $tz, $cq)
    {
        ...
        foreach ($statusTasklist as $taskkey => $caseAll)
        {
            ...
            foreach ($caseAll as $caseKey => $getdata)
            {
                ...
                $chkDateTime1 = $newdate_actualdate[0];
                $projIdcnt = $newpjcnt;
                unset($caseAll[$caseKey]['Easycase']['updated_by'], $caseAll[$caseKey]['Easycase']['message'], $caseAll[$caseKey]['Easycase']['hours'], $caseAll[$caseKey]['Easycase']['completed_task'], $caseAll[$caseKey]['Easycase']['due_date'], $caseAll[$caseKey]['Easycase']['istype'], $caseAll[$caseKey]['Easycase']['status'], $caseAll[$caseKey]['Easycase']['dt_created'], $caseAll[$caseKey]['Easycase']['actual_dt_created'], $caseAll[$caseKey]['Easycase']['reply_type'], $caseAll[$caseKey]['Easycase']['id_seq'], $caseAll[$caseKey]['Easycase']['end_date'], $caseAll[$caseKey]['Easycase']['Mproject_id'], $caseAll[$caseKey][0], $caseAll[$caseKey]['User']);
            }
    ...
    /**
     * to retrive the latest 3 Milestone and respective tasks
     * @return array()
     */
