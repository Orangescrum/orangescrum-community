...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.el = el;
		base.$el = $(el).addClass('anythingBase').wrap('<div class="anythingSlider"><div class="anythingWindow"><div class="anythingWindowInner" /></div></div>');
		...
		base.init = function(){
			...
			base.$startStop = $('<a href="#" class="start-stop" style="display:none"></a>');
			if (o.buildStartStop) {
	...
	$.anythingSlider.defaults = {
		...
		animationTime       : 600,
		easing       		: 'swing',       // How long the slideshow transition takes (in milliseconds)
