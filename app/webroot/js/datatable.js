...
(/** @lends <global> */function($, window, document, undefined) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "<div style='text-align:center;width:100%;color:#FF0000;line-height:32px;'>No data available</div>",
			 ...
			 *    } );
			 */
			"sInfo": "<span> _START_ to _END_ of _TOTAL_</span>",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "<span>0 to 0 of 0</span>",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "<span style='padding-left:0px;'>(filtered from _MAX_ total records)<span>",
			 ...
			 *    } );
			 */
			"sZeroRecords": "<div style='text-align:center;width:100%;color:#FF0000;line-height:32px;'>No matching records found</div>"
		},
