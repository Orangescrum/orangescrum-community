			...
			<table cellpadding="8" cellspacing="8" style="border:1px solid #999999;color:#000000" align="center" width="520px">
				<tr>
					<td align="center" style="border-bottom:1px solid #999999">
						<h2 style="color:#245271">The page you requested was not found</h2>
					</td>
				</tr>
				<tr>
					<td align="center" style="padding-top:10px">
						<h3>You may have clicked an expired link or mistyped the address.<br/>Some web addresses are case sensitive.</h3>
					</td>
				</tr>
			</table>
			</td></tr></table>
