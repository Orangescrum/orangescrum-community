<?php
$metadesc = "Orangescrum is an awesome Project Management and Collaboration tool. It helps you to organize projects, team, documents & tasks at one place. No matter where your team or customers are, keep everyone on the same page.";
