        ...
        <?php if (PAGE_NAME != "help" && PAGE_NAME != "tour" && PAGE_NAME != "customer_support") { ?>
            <ul class="nav navbar-nav side-nav">
                ...
                if (SES_TYPE == 1 || SES_TYPE == 2) {
                    ...
                    ?>"><a href="<?php echo HTTP_ROOT . 'reminder-settings'; ?>"><i class="menu_sprite_ico menu_sprite_ico_gupd"></i> Daily Catch-Up</a></li>  
                        <?php
                    }
                    ?>
                ...
                ?><?php
                if (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report")) {
                    echo "class='active more_menu_li'";
                    echo ' style="display:block;"';
                } else {
                    if (SES_TYPE != 3) {
                ...
                ?>><a href="<?php echo HTTP_ROOT . 'task-report/'; ?>"><i class="menu_sprite_ico menu_sprite_ico_anltc"></i> Analytics</a></li>

                <li <?php
                if ((CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report")) || CONTROLLER == "templates") {
                    echo 'style="display:block;"';
                }
                ?> <?php
                ...
                ?>><a href="<?php echo HTTP_ROOT . 'archives/listall#caselist'; ?>"><i class="menu_sprite_ico menu_sprite_ico_arch"></i> Archive</a></li>
                ...
                <?php if (SES_TYPE == 1 || SES_TYPE == 2) { ?>
                    ...
                    <li <?php
                    if ((CONTROLLER == "archives" && (PAGE_NAME == "listall")) || (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report"))) {
                        echo 'style="display:block;"';
                    }
                    ?><?php
                    ...
                    ?>><a href="<?php echo HTTP_ROOT . 'templates/tasks'; ?>"><i class="menu_sprite_ico menu_sprite_ico_tmplt"></i> Template</a></li>
                ...
                <?php } ?>
                <!--			<li class="dropdown cust_rec" id="customFil" <?php
                if (((CONTROLLER == "templates") || (CONTROLLER == "archives" && (PAGE_NAME == "listall")) || (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report"))) && (SES_TYPE == 1 || SES_TYPE == 2)) {
                ...
                <li class="dropdown cust_rec" id="recentCases" <?php
                if (((CONTROLLER == "templates") || (CONTROLLER == "archives" && (PAGE_NAME == "listall")) || (CONTROLLER == "reports" && (PAGE_NAME == "glide_chart" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report"))) && (SES_TYPE == 1 || SES_TYPE == 2)) {
                    echo 'style="display:none;"';
                }
                ?>>
