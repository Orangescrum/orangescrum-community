 ...
 */
    ...
    public function getID($list = 0) 
    {
        ...
        if (!is_array($this->id)) { return $this->id;}
        if (isset($this->id[$list]) && !empty($this->id[$list])) { return $this->id[$list]; }
        if (isset($this->id[$list])) { return false; }
     ...
     */
    public function getLastInsertID() { return $this->getInsertID(); }
     ...
     * @return array
     */
    public function associations() { return $this->_associations; }
     ...
     */
    public function beforeFind($query) { return true; }
     ...
     */
    public function afterFind($results, $primary = false) { return $results; }
     ...
     */
    public function beforeDelete($cascade = true) { return true; }
     ...
     * @see Model::save()
     */
    public function beforeValidate($options = array()) { return true; }
