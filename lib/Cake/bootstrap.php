...
if (!function_exists('mb_stristr')) 
{
     ...
     *    If true, it returns all of $haystack from the start to the first occurrence of $needle.
     *    If false, it returns all of $haystack from the first occurrence of $needle to the end,
     *    Default value is false.
     * @param string $encoding Character encoding name to use. If it is omitted, internal 
...
if (!function_exists('mb_strlen')) 
{
     ...
     * @return integer The number of characters in string $string having character 
...
if (!function_exists('mb_strpos')) 
{
     ...
     * @param string $encoding Character encoding name to use. If it is omitted, internal 
     *                         character encoding is used.
     * @return integer|boolean The numeric position of the first occurrence of $needle in the 
...
if (!function_exists('mb_strrchr')) 
{
     ...
     * @param string $needle The string to find in $haystack.
     * @param boolean $part Determines which portion of $haystack this function returns.
     *    If set to true, it returns all of $haystack from the beginning to the last occurrence 
     *    of $needle.
     *    If set to false, it returns all of $haystack from the last occurrence of $needle 
     *    to the end.
     *    Default value is false.
     * @param string $encoding Character encoding name to use. If it is omitted, internal 
     *                         character encoding is used.
...
if (!function_exists('mb_strrichr')) 
{
     ...
     * @param boolean $part Determines which portion of $haystack this function returns.
     *    If set to true, it returns all of $haystack from the beginning to the last occurrence 
     *    of $needle. If set to false, it returns all of $haystack from the last occurrence of 
     *    $needle to the end,
     *    Default value is false.
     * @param string $encoding Character encoding name to use. If it is omitted, internal 
     *                         character encoding is used.
...
if (!function_exists('mb_strripos')) 
{
     ...
     *
     * @param string $haystack The string from which to get the position of the last 
     *                         occurrence of $needle.
     * @param string $needle The string to find in $haystack.
     * @param integer $offset The position in $haystack to start searching.
     * @param string $encoding Character encoding name to use. If it is omitted, internal 
     *                         character encoding is used.
     * @return integer|boolean The numeric position of the last occurrence of $needle in 
     *                         the $haystack string, or false if $needle is not found.
     */
...
if (!function_exists('mb_strrpos')) 
{
     ...
     * @param string $needle The string to find in $haystack.
     * @param integer $offset May be specified to begin searching an arbitrary number of 
     *                        characters into the string. Negative values will stop searching at 
     *                        an arbitrary point prior to the end of the string.
     * @param string $encoding Character encoding name to use. If it is omitted, internal character 
     *                                   encoding is used.
     * @return integer|boolean The numeric position of the last occurrence of $needle in the 
     *                         $haystack string. If $needle is not found, it returns false.
     */
...
if (!function_exists('mb_strstr')) 
{
     ...
     * @param string $needle The string to find in $haystack
     * @param boolean $part Determines which portion of $haystack this function returns.
     *    If set to true, it returns all of $haystack from the beginning to the first 
     *    occurrence of $needle.
     *    If set to false, it returns all of $haystack from the first occurrence of $needle to
     *    the end.
     *    Default value is FALSE.
     * @param string $encoding Character encoding name to use. If it is omitted, internal 
     *                         character encoding is used.
